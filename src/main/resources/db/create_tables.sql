...
(
    ...
    constraint rate_uk unique(public_service_id, rate_sum, date_begin),
    constraint rate_fk foreign key(public_service_id) references public_service(id)
    );
--rollback drop rate;
...
(
    ...
    constraint meter_reading_uk unique(flat_id, public_service_id, meter_reading_date),
    constraint meter_reading_fk1 foreign key(flat_id) references flat(id),
    constraint meter_reading_fk2 foreign key(public_service_id) references public_service(id)
    );
...
(
    ...
    constraint bill_uk unique(flat_id, mounth),
